  ...
  const mockBots: Bot[] = [
    {
      ...
      interests: JSON.stringify(['Arte Contemporáneo', 'Abstracto']),
      isActive: true,
      maxBids: 30,
      bidAmount: 1,
      frequency: 300,
    ...
    },
    {
      ...
      interests: JSON.stringify(['Arte Clásico', 'Impresionismo']),
      isActive: true,
      maxBids: 50,
      bidAmount: 2,
      frequency: 180,
    ...
    },
    {
      ...
      interests: JSON.stringify(['Arte Emergente', 'Fotografía']),
      isActive: true,
      maxBids: 25,
      bidAmount: 3,
      frequency: 240,
